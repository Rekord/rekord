...
{
  var timer = assert.timer();
  var prefix = 'NeuroModel_save_remote_transaction_';
...
{
  var timer = assert.timer();
  var prefix = 'NeuroModel_save_local_transaction_';
  ...
  var txn = l0.$save( Neuro.Cascade.Local );
  var done = false;
...
{
  var timer = assert.timer();
  var prefix = 'NeuroModel_save_offline_transaction_';
