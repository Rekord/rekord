...
{
  var prefix = 'NeuroShard_get_failure_';
...
{
  var prefix = 'NeuroShard_get_unknown_';
...
{
  var prefix = 'NeuroShard_create_failure_';
...
{
  var prefix = 'NeuroShard_create_unknown_';
...
{
  var prefix = 'NeuroShard_update_failure_';
...
{
  var prefix = 'NeuroShard_update_unknown_';
...
test( 'remove', function(assert)
{
  ...
  ok( t.$isSaved() );
  strictEqual( t.$status, Neuro.Model.Status.Synced );

  t.$remove();

  strictEqual( t.$status, Neuro.Model.Status.Removed );
  ok( t.$isDeleted() );
  deepEqual( shards[ 0 ].map.get( 4 ), void 0 );
  deepEqual( shards[ 1 ].map.get( 4 ), void 0 );
  deepEqual( shards[ 2 ].map.get( 4 ), void 0 );
...
{
  var prefix = 'NeuroShard_remove_failure_';
  ...
  strictEqual( t.$status, Neuro.Model.Status.RemovePending );
  ok( t.$isDeleted() );
  deepEqual( shards[ 0 ].map.get( 4 ), void 0 );
  deepEqual( shards[ 1 ].map.get( 4 ), {id: 4, name: 't4', done: false} );
  deepEqual( shards[ 2 ].map.get( 4 ), void 0 );
...
{
  var prefix = 'NeuroShard_remove_unknown_';
...
{
  var prefix = 'NeuroShard_all_failure_';
...
{
  var prefix = 'NeuroShard_query_default_';
...
{
  var prefix = 'NeuroShard_query_specific_';
...
{
  var prefix = 'NeuroShard_query_failure_atomic_';
...
{
  var prefix = 'NeuroShard_query_failure_not_atomic_';
...
{
  var prefix = 'NeuroShard_save_multiple_';
  ...
  var sharder = {
    getShardsForModel: function(model) {
      if ( !Neuro.isNumber( model.user_id ) || !Neuro.isNumber( model.group_id ) ) {
